...
<body style="background-image: url(upload_images/images01.png);">

	<div class="container">
	<u></u><h1 style="text-align: center; padding-top: 5px; background-color: #ffffffc9;">Student Crud Record</h1></u>
	<form method="post">
        <button type="submit" name="back_button" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> Back </button>
...
<div id='edit$id' class='modal fade' role='dialog'>
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      <div class='modal-header'>
             <button type='button' class='close' data-dismiss='modal'>&times;</button>
             <h4 class='modal-title text-center'>Edit Form Data</h4> 
      </div>
      ...
      <div class='modal-body'>
		...
		<input type='text' class='form-control' name='card_no' placeholder='Enter 13-digit Student Id.' maxlength='12' value='$card' required>
		</div>
		<div class='form-group col-md-6'>
		<label for='inputPassword4'>Mobile No.</label>
		<input type='phone' class='form-control' name='user_phone' placeholder='Enter 11-digit Mobile no.' maxlength='10' value='$phone' required>
		</div>
		</div>
		...
		<div class='form-group col-md-6'>
		<label for='mothername'>Sur-Name</label>
		...
		<input type='text' class='form-control' name='user_cnic' maxlength='12' placeholder='Enter 13-digit cnic no. ' value='$cnic'>
		</div>
		</div>
		...
		<input type='text' class='form-control' name='village' placeholder='Current Address' value='$village'>
		</div>
		<div class='form-group'>
		<label for='inputAddress2'>Note</label>
		<input type='text' class='form-control' name='police_station' placeholder='Any Note Mention' value='$police'>
		</div>
		<div class='form-row'>
		<div class='form-group col-md-6'>
		...
		<input type='text' class='form-control' name='staff_id' maxlength='12' placeholder='Enter 13-digit Staff Id' value='$staffCard'>
		</div>
